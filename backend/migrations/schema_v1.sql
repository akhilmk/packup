...
-- Junction table for per-user state of customer tasks
...
CREATE INDEX IF NOT EXISTS idx_todos_customer ON todos(is_customer_task) WHERE is_customer_task = true;
